//document.oncontextmenu = function(){return false} //funcion para bloquear el click derecho del mouse
	...
	//   tamaño de la ruleta 
      ...
      var data = [
        ...
        // declarando  funcion generadora arc
        ...
        var arcs = vis.selectAll("g.slice")
            ...
            .text( function(d, i) {
                ...
                function cambiarTamaño(){
                    if (screen.width < 1024) {
                        var tamaño = document.querySelector("body");
                        tamaño.setAttribute("id", "ruleta");

                        var clientWidth = document.getElementById("ruleta").clientWidth;
                        var clientHeight = document.getElementById("ruleta").clientHeight;

                        alert("El tamaño es " + clientWidth + " X " + clientHeight);


                        /*var Ruleta = document.getElementById("ruleta");
                        Ruleta.style.backgorundColor = "#00CC00";*/
                    }
                }
                cambiarTamaño();
     ...
     container.append("circle")  
      ...
      .attr("cy", 0)
       ...
       if (screen.width < 800) {
            ...
            circulo.removeAttribute('r');
            circulo.setAttribute('r', 180);
       }if (screen.width < 700){
            circulo.removeAttribute('r');
            circulo.setAttribute('r', 160);
       }if (screen.width < 600){
            circulo.removeAttribute('r');
            circulo.setAttribute('r', 140);
        }if (screen.width < 550){
            circulo.removeAttribute('r');
            circulo.setAttribute('r', 120);
        }      
